...
export const ACTIONS = {
	...
	[Action.Dodge]: new ActionDefinition({
		...
		type: ActionType.Defense,
		name: 'Dodge',
		description: 'Defend Body against a Basic Attack with Evasiveness + 3 instead.',
		traits: [ActionTrait.Reaction],
		costs: [new ActionCost({ resource: ActionCostResource.ActionPoint, amount: 1 })],
	}),
	...
	[Action.Calm]: new ActionDefinition({
		...
		costs: [
			new ActionCost({ resource: ActionCostResource.ActionPoint, amount: 1 }),
			new ActionCost({ resource: ActionCostResource.VitalityPoint, amount: 1 }),
		],
	}),
	...
	[Action.KarmicResistance]: new ActionDefinition({
		...
		costs: [
			new ActionCost({ resource: ActionCostResource.ActionPoint, amount: 0 }),

export var StatHierarchy;
(function (StatHierarchy) {
    StatHierarchy["Level"] = "Level";
    StatHierarchy["Realm"] = "Realm";
    StatHierarchy["Attribute"] = "Attribute";
    StatHierarchy["Skill"] = "Skill";
...
export var StatTypeName;
(function (StatTypeName) {
    StatTypeName["Level"] = "Level";
    StatTypeName["Body"] = "Body";
    StatTypeName["Mind"] = "Mind";
    StatTypeName["Soul"] = "Soul";
    StatTypeName["STR"] = "STR";
    StatTypeName["DEX"] = "DEX";
    StatTypeName["CON"] = "CON";
    StatTypeName["INT"] = "INT";
    StatTypeName["WIS"] = "WIS";
    StatTypeName["CHA"] = "CHA";
    StatTypeName["LCK"] = "LCK";
    StatTypeName["DIV"] = "DIV";
    StatTypeName["FOW"] = "FOW";
    StatTypeName["Muscles"] = "Muscles";
    StatTypeName["Stance"] = "Stance";
    StatTypeName["Lift"] = "Lift";
    StatTypeName["Finesse"] = "Finesse";
    StatTypeName["Evasiveness"] = "Evasiveness";
    StatTypeName["Agility"] = "Agility";
    StatTypeName["Toughness"] = "Toughness";
    StatTypeName["Stamina"] = "Stamina";
    StatTypeName["Resilience"] = "Resilience";
    StatTypeName["IQ"] = "IQ";
    StatTypeName["Knowledge"] = "Knowledge";
    StatTypeName["Memory"] = "Memory";
    StatTypeName["Perception"] = "Perception";
    StatTypeName["Awareness"] = "Awareness";
    StatTypeName["Intuition"] = "Intuition";
    StatTypeName["Speechcraft"] = "Speechcraft";
    StatTypeName["Presence"] = "Presence";
    StatTypeName["Empathy"] = "Empathy";
    StatTypeName["Devotion"] = "Devotion";
    StatTypeName["Aura"] = "Aura";
    StatTypeName["Attunement"] = "Attunement";
    StatTypeName["Discipline"] = "Discipline";
    StatTypeName["Tenacity"] = "Tenacity";
    StatTypeName["Resolve"] = "Resolve";
    StatTypeName["Fortune"] = "Fortune";
    StatTypeName["Karma"] = "Karma";
    StatTypeName["Serendipity"] = "Serendipity";
...
export class StatType {
    ...
    longDescription;
    exampleUsages;
    static build = ({ hierarchy, parent, name, description, longDescription = undefined, exampleUsages = [], }) => {
        return new StatType(hierarchy, parent, name, description, longDescription, exampleUsages);
    };
    static Level = StatType.build({
...
`,
    ...
    static Evasiveness = StatType.build({
        hierarchy: StatHierarchy.Skill,
        parent: StatType.DEX,
    ...
    static Toughness = StatType.build({
        hierarchy: StatHierarchy.Skill,
        parent: StatType.CON,
    ...
    static Resilience = StatType.build({
        hierarchy: StatHierarchy.Skill,
        parent: StatType.CON,
    ...
    static Knowledge = StatType.build({
        hierarchy: StatHierarchy.Skill,
        parent: StatType.INT,
    ...
    static Perception = StatType.build({
        hierarchy: StatHierarchy.Skill,
        parent: StatType.WIS,
    ...
    static Awareness = StatType.build({
        hierarchy: StatHierarchy.Skill,
        parent: StatType.WIS,
    ...
    static Intuition = StatType.build({
        hierarchy: StatHierarchy.Skill,
        parent: StatType.WIS,
    ...
    static Speechcraft = StatType.build({
        hierarchy: StatHierarchy.Skill,
        parent: StatType.CHA,
    ...
    static Presence = StatType.build({
        hierarchy: StatHierarchy.Skill,
        parent: StatType.CHA,
    ...
    static Devotion = StatType.build({
        hierarchy: StatHierarchy.Skill,
        parent: StatType.DIV,
    ...
    static Attunement = StatType.build({
        hierarchy: StatHierarchy.Skill,
        parent: StatType.DIV,
    ...
    static Discipline = StatType.build({
        hierarchy: StatHierarchy.Skill,
        parent: StatType.FOW,
    ...
    static Tenacity = StatType.build({
        hierarchy: StatHierarchy.Skill,
        parent: StatType.FOW,
    ...
    static Serendipity = StatType.build({
        hierarchy: StatHierarchy.Skill,
        parent: StatType.LCK,
    ...
    constructor(hierarchy, parent, name, description, longDescription, exampleUsages) {
    ...
    static values = Object.values(StatType).filter(stat => stat.description);
    static fromString(name, fallback) {
        if (!name) {
            return fallback;
        }
...
//# sourceMappingURL=stat-type.js.map
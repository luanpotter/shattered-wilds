import { F } from './formula.js';
import { StatType } from './stat-type.js';
export var Resource;
(function (Resource) {
    Resource["HeroismPoint"] = "HeroismPoint";
    Resource["VitalityPoint"] = "VitalityPoint";
    Resource["FocusPoint"] = "FocusPoint";
    Resource["SpiritPoint"] = "SpiritPoint";
    Resource["ActionPoint"] = "ActionPoint";
})(Resource || (Resource = {}));
export class ResourceCost {
    resource;
    amount;
    variable;
    constructor({ resource, amount, variable = false }) {
...
export class ResourceDefinition {
    ...
    shortCode;
    description;
    color; // rgb hex representing the resource
    formula;

...
import { ArcaneComponentMode, BASIC_EQUIPMENT, BasicEquipmentType, Equipment, Item, PrimaryWeaponType, SlotType, WeaponMode, } from './equipment';
...
describe('equipment serialization and rehydration', () => {
    ...
    it('multi-mode weapons retain their class instances after roundtrip', () => {
        ...
        const lightMode = rehydratedHatchet.modes[0];
        const thrownMode = rehydratedHatchet.modes[1];
    ...
    it('arcane foci preserve nested costs, traits, and bonuses', () => {
        ...
        const rehydratedMode = rehydratedFocus.modes[0];
        ...
        expect(modeCost).toEqual(focus.modes[0].costs[0]);
    });

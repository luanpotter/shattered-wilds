...
import { DistanceInput, DropdownInput, FixedBonusInput, FixedDistanceInput, NumberInput, ResourceInput, } from '../common/section-inputs.js';
...
export class ActionsSectionInputFactory {
    ...
    getInputsForActionType(type) {
        return this.getInputsForActionTypeOrUndefined(type).filter((e) => e !== undefined);
    }
    getInputsForActionTypeOrUndefined(type) {
...
//# sourceMappingURL=actions-section-inputs.js.map
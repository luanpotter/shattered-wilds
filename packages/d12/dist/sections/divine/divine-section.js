...
export class DivineSection {
    ...
    static create({ characterId, characterSheet, }) {
        ...
        const pureDivineChanneling = new ActionRow({
            ...
            description: 'A plea to the forces of the beyond to grant a desired effect. The vaguer the request, the more likely it is for it to succeed in some form or another.',
            cost,
...
//# sourceMappingURL=divine-section.js.map
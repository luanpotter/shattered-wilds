...
(function (Consequence) {
    Consequence["Exhaustion"] = "Exhaustion";
    Consequence["Poisoned"] = "Poisoned";
    Consequence["Death"] = "Death";
...
* _Ranks_ 10+: [[Death]].`,
    ...
    [Consequence.Poisoned]: new ConsequenceDefinition({
        ...
        ranked: true,
        description: `A non-trivial amount of toxin lingers on your system. Your maximum [[Vitality_Points | VP]] is reduced by your [[Poisoned]] _rank_ (if it reaches \`0\`, you die from the poison).
...
//# sourceMappingURL=consequences.js.map
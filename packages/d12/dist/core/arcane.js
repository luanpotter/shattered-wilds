...
export var ArcaneSpellAugmentationType;
(function (ArcaneSpellAugmentationType) {
    ArcaneSpellAugmentationType["Material"] = "Material";
    ArcaneSpellAugmentationType["Intensity"] = "Intensity";
    ArcaneSpellAugmentationType["Area"] = "Area";
    ArcaneSpellAugmentationType["Volume"] = "Volume";
    ArcaneSpellAugmentationType["Duration"] = "Duration";
    ArcaneSpellAugmentationType["Specificity"] = "Specificity";
})(ArcaneSpellAugmentationType || (ArcaneSpellAugmentationType = {}));
export var ArcaneSpellSchool;
(function (ArcaneSpellSchool) {
    ArcaneSpellSchool["Conjuration"] = "Conjuration";
    ArcaneSpellSchool["Evocation"] = "Evocation";
    ArcaneSpellSchool["Transmutation"] = "Transmutation";
    ArcaneSpellSchool["Transfiguration"] = "Transfiguration";
    ArcaneSpellSchool["Command"] = "Command";
    ArcaneSpellSchool["Telekinesis"] = "Telekinesis";
})(ArcaneSpellSchool || (ArcaneSpellSchool = {}));
...
export var ArcaneSpellComponentType;
(function (ArcaneSpellComponentType) {
    ArcaneSpellComponentType["Somatic"] = "Somatic";
    ArcaneSpellComponentType["Verbal"] = "Verbal";
    ArcaneSpellComponentType["Focal"] = "Focal";
})(ArcaneSpellComponentType || (ArcaneSpellComponentType = {}));
...
export const ARCANE_SPELL_COMPONENTS = [
    new ArcaneSpellComponentDefinition({
        type: ArcaneSpellComponentType.Somatic,
        name: 'No Somatic Component',
        flavors: allCasterFlavors,
...
export class ArcaneSpellAugmentation {
    ...
    bonus;
    variable;
    constructor({ type, value, bonus, variable = false, }) {
        this.type = type;
        this.value = value;
        this.bonus = bonus;
...
export var PredefinedArcaneSpell;
(function (PredefinedArcaneSpell) {
    PredefinedArcaneSpell["ConjureWater"] = "Conjure Water";
    PredefinedArcaneSpell["RockSmash"] = "Rock Smash";
    PredefinedArcaneSpell["ConjureDebris"] = "Conjure Debris";
    PredefinedArcaneSpell["PoisonCloud"] = "Poison Cloud";
    PredefinedArcaneSpell["EvokeLight"] = "Evoke Light";
    PredefinedArcaneSpell["BlindingLight"] = "Blinding Light";
    PredefinedArcaneSpell["EvokeFlames"] = "Evoke Flames";
    PredefinedArcaneSpell["MudFeet"] = "Mud Feet";
    PredefinedArcaneSpell["MendObject"] = "Mend Object";
    PredefinedArcaneSpell["MageHand"] = "Mage Hand";
    PredefinedArcaneSpell["ControlFlames"] = "Control Flames";
    PredefinedArcaneSpell["MagicShove"] = "Magic Shove";
    PredefinedArcaneSpell["HardenFists"] = "Harden Fists";
    PredefinedArcaneSpell["HardenSkin"] = "Harden Skin";
    PredefinedArcaneSpell["DisguiseBeing"] = "Disguise Being";
    PredefinedArcaneSpell["HideousVisage"] = "Hideous Visage";
    PredefinedArcaneSpell["ConfuseMind"] = "Confuse Mind";
    PredefinedArcaneSpell["ErodeWill"] = "Erode Will";
    PredefinedArcaneSpell["MessageBeing"] = "Message Being";
    PredefinedArcaneSpell["GuideAnimal"] = "Guide Animal";
    PredefinedArcaneSpell["CommandBeing"] = "Command Being";
})(PredefinedArcaneSpell || (PredefinedArcaneSpell = {}));
export const PREDEFINED_ARCANE_SPELLS = {
    ...
    [PredefinedArcaneSpell.RockSmash]: new ArcaneSpellDefinition({
        ...
        school: ArcaneSpellSchool.Conjuration,
        description: 'Conjures a medium-sized boulder of weak rock above the target, which can be used as a **Mind Attack** against **Body Defense** to avoid being hit by the falling debris and receiving 1 [[Vitality_Points | VP]] of damage.',
        augmentations: [
            new ArcaneSpellAugmentation({
    ...
    [PredefinedArcaneSpell.ConjureDebris]: new ArcaneSpellDefinition({
        ...
        school: ArcaneSpellSchool.Conjuration,
        description: 'Conjures loose weak rocks, pebbles and/or gravel over an area, causing it to count as **Difficult Terrain**. Each Hex of debris can be cleared gradually with 4 [[Action_Points | AP]] worth of actions.',
        augmentations: [
            new ArcaneSpellAugmentation({
    ...
    [PredefinedArcaneSpell.PoisonCloud]: new ArcaneSpellDefinition({
        ...
        school: ArcaneSpellSchool.Conjuration,
        description: 'Conjures a cloud of **Noxious Gas** over an area. The area _can_ be occupied by other creatures or objects, as the gas will be created around them. As the gas disperses, it lose its potency after 3 rounds. Creating more gas on the same space will just dislodge the excess poison around.',
        augmentations: [
            new ArcaneSpellAugmentation({
                type: ArcaneSpellAugmentationType.Area,
                value: 'Hex',
...
//# sourceMappingURL=arcane.js.map
...
import { F, RoundMode } from '../stats/formula.js';
...
(function (ActionType) {
    ...
    ActionType["Heroic"] = "Heroic";
    ActionType["Meta"] = "Meta";
})(ActionType || (ActionType = {}));
export var ActionValueUnit;
(function (ActionValueUnit) {
    ActionValueUnit["Hex"] = "Hex";
    ActionValueUnit["Modifier"] = "Modifier";
...
export var StandardCheck;
(function (StandardCheck) {
    /** Will use STR or DEX depending on the selected Weapon. */
    StandardCheck["BodyAttack"] = "BodyAttack";
    /** Will use Body, Mind or Soul depending on the selected Defense Realm. */
    StandardCheck["Defense"] = "Defense";
})(StandardCheck || (StandardCheck = {}));
export var IncludeEquipmentModifier;
(function (IncludeEquipmentModifier) {
    IncludeEquipmentModifier["Weapon"] = "Weapon";
    IncludeEquipmentModifier["Armor"] = "Armor";
    IncludeEquipmentModifier["Shield"] = "Shield";
})(IncludeEquipmentModifier || (IncludeEquipmentModifier = {}));
export class ActionCheckParameter {
    ...
    static bodyAttack({ statType = StandardCheck.BodyAttack, circumstanceModifier, } = {}) {
        return this.attack({
            statType,
    ...
    static bodyDefense({ statType = StandardCheck.Defense, includeEquipmentModifiers = [IncludeEquipmentModifier.Armor], circumstanceModifier, } = {}) {
        return this.defense({
            statType,
            includeEquipmentModifiers,
            circumstanceModifier,
...
(function (Action) {
    Action["Aim"] = "Aim";
    Action["Stride"] = "Stride";
    Action["Stun"] = "Stun";
    Action["CatchBreath"] = "CatchBreath";
    Action["KarmicResistance"] = "KarmicResistance";
    Action["WriteHistory"] = "WriteHistory";
    Action["ExtraDie"] = "ExtraDie";
    Action["Feint"] = "Feint";
    ...
    Action["Calm"] = "Calm";
    Action["Focus"] = "Focus";
    Action["HeroicRelentlessness"] = "HeroicRelentlessness";
    Action["OpportunityAttack"] = "OpportunityAttack";
    Action["Run"] = "Run";
    Action["ShrugOff"] = "ShrugOff";
    Action["FocusedStrike"] = "FocusedStrike";
    Action["Demoralize"] = "Demoralize";
    Action["Trip"] = "Trip";
    Action["LuckDie"] = "LuckDie";
    Action["DragGrappler"] = "DragGrappler";
    ...
    Action["SteelConviction"] = "SteelConviction";
    Action["SideStep"] = "SideStep";
    Action["ShieldBlock"] = "ShieldBlock";
    Action["SheatheUnsheathe"] = "SheatheUnsheathe";
    Action["Reload"] = "Reload";
    Action["Flank"] = "Flank";
    Action["Dodge"] = "Dodge";
    Action["Disarm"] = "Disarm";
    Action["DecreaseInitiative"] = "DecreaseInitiative";
    Action["BasicDefense"] = "BasicDefense";
})(Action || (Action = {}));
export const ACTIONS = {
    ...
    [Action.Stride]: new ActionDefinition({
        ...
        name: 'Stride',
        description: 'Enables you to move up to your [[Movement]]. Movement cannot be saved for later except during a sequence of Movement Actions.',
    ...
    [Action.Run]: new ActionDefinition({
        ...
        type: ActionType.Movement,
        name: 'Run',
        description: 'Move up to `4 * Movement` hexes. Make a [[Stamina]] Check DC `10 + hexes moved`, or pay 1 [[Vitality_Points | VP]].',
    ...
    [Action.DragGrappler]: new ActionDefinition({
        ...
        type: ActionType.Movement,
        name: 'Drag Grappler',
        description: 'Move 1 hex while [[Immobilized]], dragging your grappler with you. Requires a contested [[Muscles]] check against [[Stance]] with a `-3` [[Circumstance Modifier | CM]]. You can use more [[Action_Points | APs]] to move extra hexes.',
    ...
    [Action.PassThrough]: new ActionDefinition({
        ...
        type: ActionType.Movement,
        name: 'Pass Through',
        description: "Contested [[Finesse]] check against opponent's [[Stance]]. Move past one enemy to an adjacent hex, as long as your [[Movement]] is 2 or more.",
        costs: [new ResourceCost({ resource: Resource.ActionPoint, amount: 1 })],
        parameters: [
            new ActionCheckParameter({
                mode: CheckMode.Contested,
    ...
    [Action.SideStep]: new ActionDefinition({
        ...
        type: ActionType.Movement,
        name: 'Side Step',
        description: 'Move 1 hex in any direction, ignoring **Difficult Terrain**. This does not trigger [[Opportunity_Attack | Opportunity Attacks]].',
        costs: [new ResourceCost({ resource: Resource.ActionPoint, amount: 1 })],
        parameters: [
            new ActionValueParameter({
                name: 'Distance',
    ...
    [Action.Sneak]: new ActionDefinition({
        ...
        type: ActionType.Movement,
        name: 'Sneak',
        description: 'Move `Movement - 1` hexes making an additional [[Finesse]] check. Any other participant for which you are concealed can make a contested [[Awareness]] check to spot you. Typically used after taking the [[Hide]] action.',
        costs: [new ResourceCost({ resource: Resource.ActionPoint, amount: 1 })],
        parameters: [
            new ActionValueParameter({
                name: 'Distance',
    ...
    [Action.Charge]: new ActionDefinition({
        ...
        type: ActionType.Movement,
        name: 'Charge',
        description: 'Move `Movement + 1` hexes in a straight line, followed by a Melee **Body Attack** with [[Muscles]] instead (you still pay the [[Action Point | AP]] cost for that action). This can be used for a "tackle" if the [[Shove]] Attack Action is chosen, in which case a `+3` [[Circumstance Modifier | CM]] is granted to the attacker.',
    ...
    [Action.Strike]: new ActionDefinition({
        ...
        name: 'Strike',
        description: '**Body Attack** against **Body Defense**. Deals [[Vitality_Points | VP]] damage. **Crit Shifts** deal extra [[Vitality_Points | VP]] damage.',
    ...
    [Action.Stun]: new ActionDefinition({
        ...
        type: ActionType.Attack,
        name: 'Stun',
        description: '**Body Attack** against **Body Defense**. Causes [[Off_Guard | Off-Guard]]. **Crit Shifts** deal [[Vitality_Points | VP]] damage.',
        costs: [new ResourceCost({ resource: Resource.ActionPoint, amount: 1 })],
        traits: [Trait.BodyAttack, Trait.Melee],
        parameters: [ActionCheckParameter.bodyAttack(), ActionCheckParameter.bodyDefense()],
    }),
    [Action.Feint]: new ActionDefinition({
        ...
        type: ActionType.Attack,
        name: 'Feint',
        description: '**Body Attack** against [[Tenacity]]. Causes [[Distracted]]. **Crit Shifts** deal [[Focus_Points | FP]] damage.',
        traits: [Trait.BodyAttack],
        costs: [new ResourceCost({ resource: Resource.ActionPoint, amount: 1 })],
    ...
    [Action.Aim]: new ActionDefinition({
        ...
        type: ActionType.Attack,
        name: 'Aim',
        description: 'Target a specific enemy that you can see clearly; if your next action this turn is a **Body Ranged Attack** against that target, you can roll with [[Finesse]] instead reduce the range increment by `1` (min `0`).',
    ...
    [Action.Trip]: new ActionDefinition({
        ...
        type: ActionType.Attack,
        name: 'Trip',
        description: '**Body Attack** against [[Stance]]. Causes opponent to be [[Prone]]. Shifts deal [[Vitality_Points | VP]] damage.',
        costs: [new ResourceCost({ resource: Resource.ActionPoint, amount: 1 })],
        traits: [Trait.BodyAttack, Trait.Melee],
    ...
    [Action.Shove]: new ActionDefinition({
        ...
        type: ActionType.Attack,
        name: 'Shove',
        description: '**Body Attack** against [[Stance]]. Shoves opponent to the next hex in the incoming direction. A Shift can be used to apply the [[Prone]] condition.',
        costs: [new ResourceCost({ resource: Resource.ActionPoint, amount: 1 })],
        traits: [Trait.BodyAttack, Trait.Melee],
        parameters: [ActionCheckParameter.bodyAttack(), ActionCheckParameter.defense({ statType: StatType.Stance })],
    }),
    ...
    [Action.Demoralize]: new ActionDefinition({
        ...
        type: ActionType.Attack,
        name: 'Demoralize',
        description: "**Special Attack** using [[Speechcraft]] against target's [[Resolve]]: target becomes [[Distraught]]. **Shifts** deal [[Spirit_Points | SP]] damage.",
        costs: [new ResourceCost({ resource: Resource.ActionPoint, amount: 1 })],
    ...
    [Action.OpportunityAttack]: new ActionDefinition({
        ...
        description: 'Triggered by an opponent either (1) leaving your threat area or (2) performing a [[Concentrate]] action on your threat area. You can choose what kind of **Melee Basic Attack** to perform as your Opportunity Attack (this will cost the same amount of [[Action_Points | AP]] as that action would (at least `1`)).',
    ...
    [Action.BasicDefense]: new ActionDefinition({
        ...
        name: 'Basic Defense',
        description: 'A **Basic Defense** that can be used against any form of **Basic Attack** - contest with either [[Body]], [[Mind]] or [[Soul]] depending on the realm of the **Attack**. This does not cost any [[Action_Points | AP]] and thus can always be responded with.',
    ...
    [Action.Dodge]: new ActionDefinition({
        ...
        type: ActionType.Defense,
        name: 'Dodge',
        description: 'Perform a **Body Defense** with an [[Evasiveness]] Check and a `+3` [[Circumstance Modifier | CM]] instead.',
        traits: [Trait.Reaction, Trait.BodyDefense],
        costs: [new ResourceCost({ resource: Resource.ActionPoint, amount: 1 })],
        parameters: [
            ActionCheckParameter.bodyDefense({
    ...
    [Action.TakeCover]: new ActionDefinition({
        ...
        type: ActionType.Defense,
        name: 'Take Cover',
        description: 'Perform a **Body Defense** against a **Ranged Body Attack** with an [[Agility]] Check and a `+6` [[Circumstance_Modifier | CM]] instead (when already benefiting from **Passive Cover**).',
        traits: [Trait.Reaction, Trait.BodyDefense],
        costs: [new ResourceCost({ resource: Resource.ActionPoint, amount: 1 })],
        parameters: [
            ActionCheckParameter.bodyDefense({
    ...
    [Action.SteelConviction]: new ActionDefinition({
        ...
        description: 'Perform a **Mind** or **Soul Defense** with a [[Resolve]] Check and a `+3` [[Circumstance_Modifier | CM]] instead.',
    ...
    [Action.Hide]: new ActionDefinition({
        ...
        type: ActionType.Support,
        name: 'Hide',
        description: "Try to conceal yourself; make a [[Finesse]] active check that can be contested by each opponent's [[Perception]] Check.",
        costs: [new ResourceCost({ resource: Resource.ActionPoint, amount: 1 })],
    ...
    [Action.ShrugOff]: new ActionDefinition({
        ...
        type: ActionType.Support,
        name: 'Shrug Off',
        description: 'Immediately as taking >1 [[Vitality_Points | VP]] damage, you can attempt a [[Toughness]] Check (DC 20) to reduce the damage by 1 (+ **Crit Shifts**).',
    ...
    [Action.Flank]: new ActionDefinition({
        ...
        type: ActionType.Support,
        name: 'Flank',
        description: 'When an ally attacks, if on Flanking position, give them a +3 [[Circumstance Modifier | CM]] to their attack roll.',
        traits: [Trait.Reaction],
        costs: [new ResourceCost({ resource: Resource.ActionPoint, amount: 1 })],
        parameters: [
            new ActionValueParameter({
    ...
    [Action.Taunt]: new ActionDefinition({
        ...
        type: ActionType.Support,
        name: 'Taunt',
        description: 'Spend 1 [[Spirit_Points | SP]]; roll a [[Presence]] Check against targets [[Resolve]] to persuade an enemy attempting to **Melee Attack** a different target to instead attack you (when you are also in range and would be a valid target).',
        traits: [Trait.Reaction],
        costs: [
            new ResourceCost({ resource: Resource.ActionPoint, amount: 1 }),
    ...
    [Action.CatchBreath]: new ActionDefinition({
        ...
        type: ActionType.Support,
        name: 'Catch Breath',
        description: 'Spend 1 [[Focus_Points | FP]] to perform a [[Stamina]] Check DC 20 (Medium): +1 [[Vitality_Points | VP]]. Regardless of result: Clears [[Off_Guard | Off-Guard]].',
        costs: [
            new ResourceCost({ resource: Resource.ActionPoint, amount: 1 }),
            new ResourceCost({ resource: Resource.FocusPoint, amount: 1 }),
        ],
    ...
    [Action.Calm]: new ActionDefinition({
        ...
        type: ActionType.Support,
        name: 'Calm',
        description: 'Spend 1 [[Vitality_Points | VP]] to perform a [[Resolve]] Check DC 20 (Medium): +1 [[Spirit_Points | SP]]; regardless of the result: Clears [[Distraught]].',
        costs: [
            new ResourceCost({ resource: Resource.ActionPoint, amount: 1 }),
    ...
    [Action.Focus]: new ActionDefinition({
        ...
        type: ActionType.Support,
        name: 'Focus',
        description: 'Spend 1 [[Spirit_Points | SP]] to perform a [[Tenacity]] Check DC 20 (Medium): +1 [[Focus_Points | FP]]; regardless of the result: Clears [[Distracted]].',
        costs: [
            new ResourceCost({ resource: Resource.ActionPoint, amount: 1 }),
            new ResourceCost({ resource: Resource.SpiritPoint, amount: 1 }),
        ],
    ...
    [Action.Inspire]: new ActionDefinition({
        ...
        type: ActionType.Support,
        name: 'Inspire',
        description: 'Make an [[Empathy]] Check DC `20` (Medium; target can resist with [[Resolve]] if they so desire): target gets a `+3` [[Circumstance Modifier | CM]] to a Attack or Defense action of their choice until the end of their next turn. Each **Crit Shifts** grants an additional `+3`.\nApply a `-3` [[Circumstance Modifier | CM]] to your check if they cannot see you.\nApply a `-6` [[Circumstance Modifier | CM]] for each additional target you are trying to inspire at once.',
        costs: [
    ...
    [Action.KarmicResistance]: new ActionDefinition({
        ...
        description: 'When you fail a **Contested Resisted Check**; pay 1 [[Heroism Point | Heroism Point]] to try to resist the same target again by using [[Karma]] instead. You cannot use [[Luck Die | Luck]] or [[Extra Die]] on this roll, or use [[Karmic Resistance]] more than once against the same [[Check]].',
        costs: [
    ...
    [Action.DecreaseInitiative]: new ActionDefinition({
        ...
        description: 'At the start of your turn, you can choose to decrease your [[Initiative]] to any value below the current. Your turn then does not start and moves down the turn order. You can never raise your initiative.',
        costs: [new ResourceCost({ resource: Resource.ActionPoint, amount: 0 })],
    }),
};
